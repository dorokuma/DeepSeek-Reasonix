...
var English = Messages{
	...
	AskTypeSomething:       "type your own answer",
	AskTypingHint:          "type and press Enter to confirm",
	AskChatInstead:         "don't pick, just chat",
	ChatStatusQuestion:     "↑/↓ select · # quick-pick · Space multi-select · Enter confirm · ←/→ switch question · Esc cancel",
	StatusResumePicker:     "select session",
	AskSubmitTitle:         "Submit answer",
	AskUnanswered:          "(unanswered)",
	AskSubmitHint:          "Enter submit · ← back to edit",
	...
	SlashHelp:          "commands: /compact · /new · /resume · /rewind · /tree · /branch · /switch · /todo · /verbose · /model (switch model) · /effort · /theme · /language · /mcp · /skills · /hooks · /paste-image · /memory · /remember · /quit · /help · plus skills (/init, /test, …)",
	...
	SkillPickerDetailMetaFmt:     "Scope: %s",
