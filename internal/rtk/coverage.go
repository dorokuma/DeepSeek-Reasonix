...
func Coverage() []CoverageEntry {
	return []CoverageEntry{
		...
		{RTKCommand: "grep", Via: "bash+builtin:grep", Notes: "bash grep; builtin engine=rtk uses rewrite gate"},
		{RTKCommand: "rg", Via: "bash+builtin:grep", Notes: "native rg → rtk rg (same filter family as grep)"},
		...
		{RTKCommand: "oc", Via: "bash", Notes: "OpenShift CLI compact filter"},
