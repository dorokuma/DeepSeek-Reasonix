...
const bashToolSteer = " Use for builds, tests, git, package managers, etc. For file operations, prefer the dedicated built-in tools over shell utilities — they behave identically on every OS."
